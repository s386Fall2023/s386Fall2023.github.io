...
excerpt: Instructions and tips on how to create a new blog post.   
classes: wide
---
...
**Please be extra careful about only using freely available images (unless you have express permission from the creator).  Here are some [resources](https://copyright.byu.edu/free-image-resources) from the BYU copyright office for finding free images.**
